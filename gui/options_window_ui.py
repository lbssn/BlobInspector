...
class Ui_OptionsWindow(object):
    def setupUi(self, OptionsWindow):
        ...
        self.gridLayout.addWidget(self.pb_UpdateProfile, 25, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_Quit, 25, 7, 1, 3)
        ...
        self.gridLayout.addWidget(self.lb_Density, 20, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_DensityKernelSize, 20, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.le_DensityLayers, 20, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_CreateNewProfile, 25, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.lb_DensityLayers, 20, 5, 1, 3)
        ...
        self.gridLayout.addWidget(self.le_DensityKernelSize, 20, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_StackAcquistionParameters, 21, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lb_StackInfoSliceThickness, 21, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.le_StackInfoSliceThickness, 21, 4, 1, 1)

        self.horizontalSpacer_7 = QSpacerItem(153, 22, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_7, 21, 6, 1, 4)
        ...
        self.gridLayout.addWidget(self.lb_StackInfoIntersliceSpace, 22, 2, 1, 1)
